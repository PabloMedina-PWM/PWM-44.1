async function changeContent(page, json) {
    ...
    addTable(json);
    hideShowColumns(json);
    hideShowFilters(json);
    configTableButtons(json);
    configAddButton(json);
}
...
function configTableButtons(json) {
